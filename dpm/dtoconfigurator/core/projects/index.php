...
SharedManager::saveLog("log_index", "View for Project: $project");
$menu_header_display = 'Search Project';
$index = "1";
$currentUser = isset($_SESSION['username']) ? $_SESSION['username'] : '';

$mode = isset($_GET['mode']) ? $_GET['mode'] : 'configurator';
$isConfigurator = ($mode === 'configurator');
?>
<!DOCTYPE html>
<html>
<head>
    <title>OneX | Search Project</title>
