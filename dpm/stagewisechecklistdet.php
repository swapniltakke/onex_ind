        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="framecontent">
               ...
               <a href="add_stagewisecheckitem.php">
...
<br>	</br>		
			...
			<div class="row">
				<div class="col-md-12">
					<div class="blockhead">
					<h3><i class="fa fa-map-marker"></i>Stagewise Checklist Details</h3>
					</div>
				</div>
			   </div>
			<div class="card">
...
var table=  $('#example1').DataTable({
    'paging'      : true,
	 'lengthChange': true,
	  ...
	  'destroy': true,
	    "sAjaxSource": "load_stagewisechecklist.php",
         "aoColumns": [
                    {mData: 'sr_no'},
					{mData: 'stage_name'},
