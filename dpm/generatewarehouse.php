        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <ul id="accordion" class="accordion nav nav-pills nav-sidebar flex-column">
                    ...
                    <li><a href="generatewarehouse.php">
                            <div class="link"><i class="fa fa-hourglass-start"></i><span>Scan </span></div>
                        </a></li>
                    <li><a href="warehousedetails.php">
...
-->
                    <li>
                        <A href="logout.php">
                            <div class="link"> <i class="fa fa-sign-out nav-icon"></i><span>Logout</span>
                        </a>
            </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="framecontent">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="blockhead">
                                        <h3><i class="fa fa-address-card"></i> Scan Page</h3>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-body formarea smpadding">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" id="outputBox1" name="outputBox1" placeholder="Serial No"
                                                readonly>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="hidden" class="form-control" id="station_id" name="station_id"
                                                readonly>
                                            <input type="text" class="form-control" id="station_name" name="station_name" placeholder="Warehouse" readonly>
...
--->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <label>Missing Assembly:</label>
                                        </div>
                                        <div class="col-md-4">
                                            <select class="form-control" name="mis_assembly" id="mis_assembly" required>
                                                <!-- <option value="">Please select an option</option>  -->
                                                <option value="y" required>Yes</option>
                                                <option value="n" required>No</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <input type="button" value="Delivered" id="start_step" class="btn btn-primary">
                                    </div>
                                    </br>
                                    <!-- /.card-body -->
    ...
    <footer class="main-footer">
        <div class="col-md-12 text-center">2025 DPM</div>
    ...
    $('#scan_id').click(function() {
        ...
        if (scanqrcode.length >= 52) {
            ...
            if (remaining.length > 65) {
                ...
                document.getElementById("mis_assembly").value = "";
    ...
    $('#start_step').on('click', function() {
        ...
        var scanqrcode = $('#scanqrcode').val();
        //var outputBox1 = $('#outputBox1').val();
        var mlfb_num = $('#mlfb_num').val();
        var machine_name = $('#machine_name').val();
        var subassem_req = $('#subassem_req').val();
        var mis_assembly = $('#mis_assembly').val();
        var remark = $('#remark').val();
        if (product_id != '') {
              $.ajax({
                  type: "POST",
                  url: 'save_waredata.php',
                  dataType: 'json',
                  data: {
                  ...
                  success: function(data) {
                      ...
                      if (x.saved == "SAVED" && x.complete == "COMPLETE") {
                          alert("Data is saved deliverd to the next station");
                          window.location.href = 'generatewarehouse.php';
                      }
                  }
              });
        } else {
    ...
    function displayInput() {
        ...
        //document.getElementById("outputBox2").value = input.substring(input.length - 12);
