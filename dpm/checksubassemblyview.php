...
$query_trans ="select tr_id from tbl_transactions where stage_id='1' and station_id='$station_id' and product_id='$product_id'";
//echo $query_remark1; //exit;
 $rs_trans = odbc_exec($conn, $query_trans);
   $tr_id=odbc_result($rs_trans,'tr_id');
      ...
      <div class="modal-content">
       ...
       <label>PDF UPLOAD: </label>
           ...
           <div id="div_breakdown" style="display:none">
                  ...
                  <label>Start Date: </label>
                                 <input type="text" class="form-control" name="start_date_break" id="start_date_break">
                                 <label>End Date: </label>
                                 <input type="text" class="form-control" name="end_date_break" id="end_date_break">
        ...
        <input type="button" class="btn btn-warning" value="Save" id="save_workbench">  <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            ...
            <input type="text" id="trans_id" value="<?php echo $tr_id;?>"> 
                ...
                <br>
             <p align="right"><input type="button" class="btn btn-primary" id="check_submit" name="Submit" value="Update"> 
...
'language': {
     ...
     "ajax": {
        'type': 'POST',
        'url': 'load_subassemblystage_view1.php',
        'data': function (data) {
       ...
       $.ajax({
           ...
           success: function (data) 
           {
               ...
               if(x.saved == "SAVED" && x.complete == "COMPLETE")
                   ...
                   else if(x.saved == "SAVED" && x.saved == "COMPLETE")
                   {
                        alert("Data is saved");
                        window.location.href = 'checksubassembly2stage.php';                   
