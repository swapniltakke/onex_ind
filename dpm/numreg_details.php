...
<div id="wrapper">
    <?php $activePage = '/dpm/numreg_details.php'; ?>
    <?php require_once $_SERVER["DOCUMENT_ROOT"]."/dpm/shared/dto_sidebar.php"; ?>
    <?php include_once 'dto/updateNumber.php'; ?>
    <div id="page-wrapper" class="gray-bg">
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    <li>
                        <h2 style="text-align: left;">Number Register Master</h2>
                    </li>
                </ul>
            </nav>
        </div>
        ...
        <?php $footer_display = 'Number Register Master';
...
<script src="dto/allNum.js?<?php echo rand(); ?>"></script>
