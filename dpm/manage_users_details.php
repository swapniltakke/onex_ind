        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="framecontent">
               ...
               <a href="add_user.php"><span class="icon-input-btn">
...
<br>	</br>		
			...
			<div class="row">
				<div class="col-md-12">
					<div class="blockhead">
					<h3><i class="fa fa-map-marker"></i> Users Details</h3>
					</div>
				</div>
			   </div>
			<div class="card">
...
$(document).ready(function(){
    ...
    $('#example1').on('click', '.show-password', function() {
        ...
        { mData: 'user_name' },
        {
            ...
            render: function(data, type, row) {
                return '<div class="input-group">' +
                    '<input type="password" class="form-control password-field" value="' + data + '">' +
