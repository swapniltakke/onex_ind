     ...
     t = void 0 !== t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.dimmer = function(t) {
         ...
         return a.each(function() {
             ...
             (m = {
                 ...
                 show: function(t) {
                     t = e.isFunction(t) ? t : function() {}, m.debug("Showing dimmer", d, g), m.set.variation(), m.is.dimmed() && !m.is.animating() || !m.is.enabled() ? m.debug("Dimmer is already shown or disabled") : (m.animate.show(t), g.onShow.call(k), g.onChange.call(k))
                 },
                 hide: function(t) {
                 ...
                 animate: {
                     show: function(t) {
                         t = e.isFunction(t) ? t : function() {}, g.useCSS && e.fn.transition !== i && d.transition("is supported") ? (g.useFlex ? (m.debug("Using flex dimmer"), m.remove.legacy()) : (m.debug("Using legacy non-flex dimmer"), m.set.legacy()), "auto" !== g.opacity && m.set.opacity(), d.transition({
         ...
         return r.each(function() {
             ...
             k = {
                 ...
                 bind: {
                     ...
                     scrollLock: function() {
                         y.get(0).addEventListener("touchmove", k.event.preventScroll, {
                             passive: !1
                         })
                     }
                 },
                 unbind: {
                     scrollLock: function() {
                         y.get(0).removeEventListener("touchmove", k.event.preventScroll, {
                             passive: !1
                         })
                     }
                 },
 ...
 function addLog(table,what){
	$.ajax( {
		url: '/api/logservice.php',
		type: 'POST',
		data: {
			table:table,
			what:what,
...
function Contact(email,width,height) {
			width = typeof width !== 'undefined' ? width : 100 ;
			height  = typeof height !== 'undefined' ? height : 100 ;
			
            $('body').append(`<div style="position:fixed;bottom:10;left:10; z-index:999999 !important;"><img src="https://onex.siemens.com.tr/images/help.png" id="supportImagePicture" width="`+width+`" height="`+height+`" style="cursor: pointer;" title="Open Support Chat in Teams"></img></div>`);
            $('#supportImagePicture').click(function() {
                var win = window.open('https://teams.microsoft.com/l/chat/0/0?users=' + email, '_blank');
                if (win) {
                    win.focus();
                }
            });
