...
$menu_header_display = 'Checklist Details';
$checklist_form = "1";
$currentUser = isset($_SESSION['username']) ? $_SESSION['username'] : '';
?>
<head>
    <title>OneX | Checklist Details</title>
...
<style>
    ...
    #resultsTable th:nth-child(4) { width: 150px !important; } /* Panel/Typical Name */
    #resultsTable th:nth-child(5) { width: 200px !important; } /* Checklist Name */
    #resultsTable th:nth-child(6) { width: 100px !important; } /* Department Name */
    #resultsTable th:nth-child(7) { width: 100px !important; } /* Product Name */
    #resultsTable th:nth-child(8) { width: 100px !important; } /* Station Name */
    #resultsTable th:nth-child(9) { width: 100px !important; } /* User */
    #resultsTable th:nth-child(10) { width: 150px !important; } /* Start Date Time */
    #resultsTable th:nth-child(11) { width: 150px !important; } /* End Date Time */
    ...
    /* Reduce padding in filter inputs */
    .ui.form .field label {
...
<body>
<div id="wrapper">
    <?php $activePage = '/checklist_details.php'; ?>
    ...
    <div id="page-wrapper" class="gray-bg">
                    ...
                    <div style="position: absolute; right: 0; top: 50%; transform: translateY(-50%); display: flex; align-items: center;">
                        <a href="/" style="display: flex; align-items: center; text-decoration: none;">
                            ...
                            <div class="logo-text">
                                <?php 
                                    if ($type === 'type2') {
                                        echo '<h5 style="margin: 0; font-size: 18px; line-height: 0.2;">
                                        ...
                                        echo '<h5 style="margin: 0; font-size: 18px; line-height: 1.2;">
                                ...
                                <?php 
                                    if ($type === 'type2') {
                                        echo '<p style="margin: 0; text-transform: uppercase; font-size: 10px; color: #6c757d; line-height: 1.2;">
        ...
        <div class="row" style="flex: 1; display: flex; flex-direction: column; margin: 0; padding: 0;">
            <div class="col-md-12" style="flex: 1; display: flex; flex-direction: column; padding: 0;">
                <div class="card">
                    <div class="card-body">
                        <!-- Filters section -->
                        <div class="ui form">
                            <div class="ui grid" style="margin: 0;">
                                <div class="three wide column" style="padding: 2px 3px;">
                                    <div class="field">
                                ...
                                <div class="three wide column" style="padding: 2px 3px;">
                                    <div class="field">
                                        <label>User</label>
                                        <div class="ui input">
                                            <input type="text" class="filter-input autocomplete" id="userFilter" data-type="user" placeholder="Enter User">
                                        </div>
                                ...
                                <div class="three wide column" style="padding: 2px 3px;">
                                    <div class="field">
                                        ...
                                        <div class="ui input">
                                            <input type="text" class="filter-input autocomplete" id="productFilter" data-type="product" placeholder="Enter Product Name">
                                        </div>
                        ...
                        <div class="table-responsive" style="width: 100%; overflow: visible; flex: 1; display: flex; flex-direction: column;">
    ...
    <?php $footer_display = 'Checklist Details';
...
<script>
    // Store the type parameter for later use
    const pageType = '<?php echo $type; ?>';
                ...
                <div class="header-info">
                    <table>
                        <tr>
                            ...
                            <td style="width: 10%"><b>Panel/Typical Name:</b></td>
    ...
    function showImageViewer(section, startIndex = 0) {
        ...
        function showImage(index) {
            currentIndex = index;
            currentScale = 1;
            const imagePath = 'uploads/' + sectionImagesList[index].filename;
            viewerImage
    ...
    $(document).ready(function() {
        ...
        // Helper function to format product name with sub_item
        function formatProductName(data) {
            let productName = data.product_name || '-';
            if (productName === 'Component' && data.sub_item) {
                productName = `Component (${data.sub_item})`;
            }
            return productName;
        }
        ...
        var table = $('#resultsTable').DataTable({
            ...
            order: [[9, 'desc']],  // Column 9 is 'Start Date Time' (create_date) - sort descending for latest first
            scrollX: true,
            scrollY: '60vh',
            scrollCollapse: true,
            fixedHeader: true,
            ajax: {
                url: '/dpm/dwc/api/checklistAPI.php?type=get_checklist_details',
                type: 'POST',
                data: function(d) {
                    ...
                    if (window.applyingFilters) {
                        ...
                        d.productFilter = $('#productFilter').val();
            ...
            columns: [
                ...
                { 
                    ...
                    render: function(data) {
                        ...
                        const typical = data.typical_name || '-';
                        return `${location}/${typical}`;
                    },
                    className: 'text-center'
                },
                { data: 'checklist_name', searchable: true, render: renderWithDash, className: 'text-center' },
                { data: 'line_name', searchable: true, render: renderWithDash, className: 'text-center' },
                { data: null, searchable: true, render: function(data) { return formatProductName(data); }, className: 'text-center' },
                { data: 'station_name', searchable: true, render: renderWithDash, className: 'text-center' },
                { data: 'user_name', searchable: true, render: renderWithDash, className: 'text-center' },
                { 
                    data: 'create_date',
                    searchable: true,
                    render: function(data) {
                ...
                { 
                    ...
                    render: function(data) {
                        ...
                        return data.updated_date ? moment(data.updated_date).format('YYYY-MM-DD HH:mm:ss') : '-';
                    },
                    className: 'text-center'
                }
            ],
                                ...
                                try {
                                    ...
                                    if (data.success && data.data) {
                                        ...
                                        data.data.forEach(row => {
                                            const panelTypical = `${row.location_name || '-'}/${row.typical_name || '-'}`;
                                            const endDateTime = row.status == 0 ? '-' : (row.updated_date ? moment(row.updated_date).format('YYYY-MM-DD HH:mm:ss') : '-');
                                            
                                            // Format product name with sub_item
                                            let productName = row.product_name || '';
                                            if (productName === 'Component' && row.sub_item) {
                                                productName = `Component (${row.sub_item})`;
                                            }
                                        ...
                                        workbook.xlsx.writeBuffer().then(buffer => {
                                            ...
                                            a.href = url;
                                            a.download = 'Checklist_Details_' + moment().format('YYYY-MM-DD_HH-mm-ss') + '.xlsx';
                                            a.click();
                            ...
                            success: function(response) {
                                try {
                                    ...
                                    if (data.success && data.data) {
                                        ...
                                        pdfMake.createPdf(docDefinition).download('Checklist_Details_' + 
        ...
        $('#resetFilters').click(function() {
            ...
            $('#orderFilter, #itemFilter, #checklistFilter, #userFilter, #dateRangeFilter, #productFilter').val('');
            ...
            // Reset filter flag and reload table
