...
SharedManager::saveLog("log_missing_material_entry", "Search for Project: $project");
$menu_header_display = 'Missing Material Entry';
?>
<head>
    <title>OneX | Missing Material Entry</title>
...
<body>
<div id="wrapper">
    <?php $activePage = '/missing_material_entry.php'; ?>
    ...
    <?php $footer_display = 'Missing Material Entry';
        ...
        function loadPanels() {
            ...
            return $.ajax({
                ...
                success: function(projectSelectionData) {
                    ...
                    // Replace the onChange handler in your loadPanels function
                    $('#panelSearch').dropdown({
                        onChange: function(value) {
                            console.log("Panel dropdown before changing to:", value);
                            value = (value || '').match(/^[^|]*/)[0];
                            ...
                            if (value) {
                                ...
                                // Get project details
                                const projectNo = $('#projectSearchInput').val() || getUrlParameters()["project"];
                                ...
                                getOrderDetail(projectNo)
                                    ...
                                    .then(() => {
                                        ...
                                        // For missing_material_entry.php, we also need to prepare the insert modal
                                        return clearInsertModal(value);
                                    })
                                    .then(() => {
                                        // Check if we're on the missing_material_entry.php page
                                        const fileName = window.location.pathname.split('/').pop();
                                        if (fileName === "missing_material_entry.php") {
                                            return openInsertModal(value);
                                        }
