    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
       ...
       <select name="w_type" class="select2 form-control" id="w_type">
                            ...
                            foreach ($res as $data) {
                              echo '<option value="'.$data['w_id'].'">'.$data['w_type'].'</option>'; 
                            }
                            ?>
           ...
           <label>Types of Breakdown: </label>
            <select name="break_type" class="select2 form-control" id="break_type">
                ...
                ?>
                  ...
                  <!-- <label>Start Date: </label>
                                 <input type="date" class="form-control" name="start_date_break" id="start_date_break" value ="<?php echo date("Y-m-d  h:i:s"); ?>" >
                                 <label>End Date: </label>
       ...
       <select name="missing_type" class="select2 form-control" id="missing_type">
                  ...
                  <label>Remark Missing Material</label>                  
							<textarea class="form-control" name="Missing_remark" id="Missing_remark"></textarea> 
...
else if(textfill == "NotFill")
{
 ...
 if (confirm('Please confirm: Do you want to complete the first stage?')) {
       $.ajax({
           url: 'save_firststageassembly.php',
           type: "POST",
           data: {
           ...
           success: function (data) {
               ...
               /*if(response.trim() == "SAVED")
                   {
                        alert("Data is saved");
                        window.location.href = 'http://localhost/Spectra/checkassemblystge2.php';                    }
           }*/
           ...
           var x = data.success 
              ...
              /*    else if(x.saved == "SAVED" && x.notcomplete == "NOTCOMPLETE")
                  {
                       alert("Data is saved");
                       window.location.href = 'checkassemblystageview.php';                   
...
//Date range picker
    ...
    //Date range picker
    $('#start_date_rework,#end_date_rework,#start_date_break,#end_date_break').datetimepicker({format: "DD/MM/YYYY hh:mm"});
