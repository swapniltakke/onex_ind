    ...
    <div class="container d-flex h-100">
        <div class="row justify-content-center align-self-center">
            ...
            <div class="col-md-6 align-self-center">
                ...
                <p>Page you are looking for is not found. Please check typo mistakes in the url. If you think that this is a server error, please contact with us.</p>
                <button id='returnOnex' style='background:teal;color:white;' class="btn">Back to OneX(10)</button>
            </div>
        </div>
    </div>
</main>
...
<script type="text/javascript">
    var countdown = 10;
    $('#returnOnex').html(`Back to OneX(${countdown})`);
    countdown--;
