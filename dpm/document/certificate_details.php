...
SharedManager::saveLog("log_certificate_master_form", "View for Project: $project");
$menu_header_display = 'Certificate Management';
...
<html>
<head>
    <title>OneX | Certificate Management</title>
    ...
    <style>
        ...
        * {
        ...
        /* ✅ ACTION BUTTONS - SAME SIZE AS DOCUMENT_DETAILS */
        .action-buttons {
            display: flex;
            gap: 8px;
            align-items: center;
        ...
        /* ✅ UNIFIED FILTER CONTROLS - MATCHING DOCUMENT_DETAILS */
        .filter-section {
        ...
        .filter-row {
            display: grid;
            grid-template-columns: 1fr 1.1fr 1.1fr 1.1fr 0.9fr 0.9fr;
            gap: 12px;
            margin-bottom: 0;
        ...
        /* ✅ FILTER BUTTONS - SAME SIZE AS DOCUMENT_DETAILS */
        .filter-buttons {
            display: flex;
            gap: 6px;
            align-items: flex-end;
        ...
        /* ✅ EDIT MODAL STYLES - COMPACT ONE PAGE */
        .edit-modal-overlay {
            display: none;
            position: fixed;
            z-index: 9998;
        ...
        /* ✅ FORM LAYOUT - THREE COLUMNS IN FIRST ROW, THEN EXPIRY (1 COL) + UPLOAD (2 COL) */
        .edit-form-row {
            display: grid;
...
<body>
<div id="wrapper">
    <?php $activePage = '/certificate_details.php'; ?>
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <!-- ✅ FILTER SECTION - MATCHING DOCUMENT_DETAILS -->
        <div class="row">
            <div class="col-md-12">
                <div class="filter-section">
                    <div class="filter-row">
                        <div class="filter-group">
                            ...
                            <select id="filterStandard" class="form-control filter-select">
                        ...
                        <div class="filter-group">
                            ...
                            <input type="text" id="filterCertificateNo" class="form-control filter-input" placeholder="Enter certificate number">
                        </div>
                        ...
                        <div class="filter-group">
                            <label for="filterExpiryDate">Expiry Date Range</label>
    ...
    <?php $footer_display = 'Certificate Management';
    include_once '../../assemblynotes/shared/footer.php'; ?>
</div>

<!-- ✅ EDIT MODAL - COMPACT ONE PAGE WITH NEW LAYOUT -->
<div id="editModalOverlay" class="edit-modal-overlay">
    <div id="editModal" class="edit-modal">
        <div class="edit-modal-header">
            <h2 class="edit-modal-title">Edit Certificate</h2>
        ...
        <div class="edit-modal-body">
            <form id="editCertificateForm">
                ...
                <!-- Row 1: Standard, Certificate No., Issue Date (3 columns) -->
                <div class="edit-form-row">
                    <div class="edit-form-group">
                        <label for="editStandard">Standard <span class="required">*</span></label>
                        <select id="editStandard" class="edit-form-select" required>
                            <option value="">-- Select Standard --</option>                          
                    ...
                    <div class="edit-form-group">
                        <label for="editCertificateNo">Certificate No. <span class="required">*</span></label>
                        <input type="text" id="editCertificateNo" class="edit-form-input" placeholder="Enter certificate number" required>
                    </div>
                ...
                <!-- Row 2: Expiry Date (1 column), Upload Certificate (2 columns) -->
                <div class="edit-form-row expiry-upload">
                    <div class="edit-form-group">
                    ...
                    <div class="edit-form-group">
                        <label>Upload Certificate (PDF) <span class="required">*</span></label>
...
<script>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    $('#editStandard').val(certificate.doc_type);
                    $('#editCertificateNo').val(certificate.certificate_no);
    ...
    function saveCertificateChanges() {
        ...
        const standard = $('#editStandard').val();
        const certificateNo = $('#editCertificateNo').val();
        ...
        if (!standard) {
            isValid = false;
            toastr.error('Please select a standard');
        }

        if (!certificateNo) {
            isValid = false;
            toastr.error('Please enter certificate number');
        }
        ...
        if (!expiryDateValue) {
            isValid = false;
            document.getElementById('editExpiryDateError').textContent = 'Expiry Date is required';
        } else {
            const dateRegex = /^(0[1-9]|[12][0-9]|3[01])\/(0[1-9]|1[012])\/\d{4}$/;
        ...
        formData.append('action', 'updateCertificate');
    ...
    function loadFilterOptions() {
        $.ajax({
            ...
            type: 'POST',
            dataType: 'json',
            data: { action: 'getStandards' },
            success: function(response) {
                const select = $('#filterStandard');
            ...
            error: function(xhr, status, error) {
                ...
                toastr.error('Error loading standards');
            }
        });
    }
    ...
    function fetchAllFilteredData() {
        return $.ajax({
            ...
            dataType: 'json',
            data: {
                action: 'getAllCertificates',
                standard: currentFilters.standard,
                certificate_no: currentFilters.certificate_no,
    ...
    function exportToExcel() {
        ...
        fetchAllFilteredData().done(function(response) {
            ...
            const headers = ['Standard', 'Certificate No.', 'Issue Date', 'Expiry Date', 'Remark'];
            ...
            workbook.xlsx.writeBuffer().then(buffer => {
                ...
                const a = document.createElement('a');
                a.href = url;
                a.download = 'Certificate_' + moment().format('YYYY-MM-DD_HH-mm-ss') + '.xlsx';
                a.click();
                window.URL.revokeObjectURL(url);
                hideFullLoader();
    ...
    function exportToPDF() {
        ...
        fetchAllFilteredData().done(function(response) {
            ...
            doc.text('Certificate Report', margin, margin + 3);
            ...
            doc.save('Certificate_' + moment().format('YYYY-MM-DD_HH-mm-ss') + '.pdf');
            hideFullLoader();
        ...
        dataTable = $('#resultsTable').DataTable({
            ...
            ajax: {
                ...
                data: function(d) {
                    ...
                    d.standard = currentFilters.standard;
                    d.certificate_no = currentFilters.certificate_no;
                ...
                },
                {
                    ...
                    render: function(data) {
                        ...
                        if (userPermissions.hasViewRights) {
                            actionHtml += `<button class="action-btn view-btn" onclick="viewCertificate(${data.id})" title="View Certificate">
            ...
            if (expiryDateRange) {
                ...
                if (expiryDates.length === 2) {
                    ...
                    if (!dateRegex.test(expiryFrom) || !dateRegex.test(expiryTo)) {
                        toastr.error('Please use YYYY-MM-DD format for expiry dates');
                        return;
                    }
                } else if (expiryDateRange !== '') {
                    toastr.error('Please use format: YYYY-MM-DD to YYYY-MM-DD for expiry dates');
                    return;
                }
            }

            currentFilters = {
                standard: escapeSpecialChars($('#filterStandard').val().trim()),
                certificate_no: escapeSpecialChars($('#filterCertificateNo').val().trim()),
