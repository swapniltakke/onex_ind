...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="pawdashboard.php" class="brand-link">
...
<li><div class="link"><a href="generatepaw.php"><i class="fa fa-hourglass-start"></i><span>Scan</span></a></div></li>
<li><div class="link"><a href="pawdetails.php"><i class="fas fa-layer-group"></i><span>List</span></a></div></li>
