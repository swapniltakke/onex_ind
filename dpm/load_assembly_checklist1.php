...
while(($filesop = fgetcsv($handle, 1000, ",")) !== false)
           {
 //$sr_no = $filesop[0];
 $current_station = $filesop[0];
 $activity=$filesop[1];
 $chk_box=$filesop[2];
 $text_req=$filesop[3];
 $product=$filesop[4];
 $new_station_no=$filesop[5];
 if($c != 0)
 {
 
 $sql = "insert into tbl_assembly_checklist(cur_station,check_item,check_req,text_req,product,new_station) values ('$current_station','$activity','$chk_box','$text_req','$product','$new_station_no')";
//echo $sql; exit;
...
<br>	</br>		
			...
			<div class="row">
				<div class="col-md-12">
					<div class="blockhead">
					<h3><i class="fa fa-map-marker"></i> Assembly Checklist Details</h3>
					</div>
				</div>
			   </div>
			<div class="card">
