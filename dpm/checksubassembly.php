    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
       ...
       <select name="break_type" class="select2 form-control" id="break_type">
				  ...
				  <textarea class="form-control" name="break_rem" id="break_rem"></textarea> 
		 ...
		 <!-- -->
		 <div id="div_safety" style="display:none">
       ...
       <select name="infra_type" class="select2 form-control" id="infra_type">
                  ...
                  <textarea class="form-control" name="Infra_rem" id="Infra_rem"></textarea> 
...
'language': {
    ...
    //data.stage_id=<?php echo $stage_id;?>;
    }
		},
   /* 'columnDefs': [
         {
...
// }
 ...
 if (confirm('Please confirm: Do you want to complete the first stage?')) {
       $.ajax({
