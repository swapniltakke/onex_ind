...
if($i == 1){
echo '<div><h7>'.strtoupper(odbc_result($query,'stage_name')).'</h7><br><button type="button" id="div_check'.$i.'"   data-toggle="modal" data-target="#myModal1" class="btn btn-success btn-circle btn-xl_pre stage_clk">'.$arr[$j].'
                            </button>
</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
} else 
{
...
'language': {
	  ...
	  'destroy': true,
	    "sAjaxSource": "load_testingstage2.php",
         "aoColumns": [
                    {mData: 'sr_no'},
					{mData: 'check_item'},
					{mData: 'actual_opt'},
...
if(remarkcnt.length == '') 
{
  ...
  if (confirm('Are you sure you want to complete Last stage of testing?')) {
        $.ajax({
