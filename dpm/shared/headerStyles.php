<head>
    ...
    <title>OneX | <?php echo $menu_header_display = isset($menu_header_display) ? $menu_header_display : 'Breaker Status'; ?></title>

    <link href="/shared/inspia_gh_assets/css/bootstrap.min.css" rel="stylesheet">
    ...
    <link href="/shared/inspia_gh_assets/css/daterangepicker.css" rel="stylesheet">
    <link href="/assemblynotes/css/customs.css" rel="stylesheet">
    <link href="/shared/inspia_gh_assets/css/plugins/chosen/bootstrap-chosen.css" rel="stylesheet">
    <link href="/assemblynotes/css/assemblyNotesMain.css?<?= rand(1,100)?>" rel="stylesheet">
</head>
<style>
