...
$jscomp.checkEs6ConformanceViaProxy = function () {
    try {
        var a = {}, h = Object.create(new $jscomp.global.Proxy(a, {
            get: function (k, e, d) {
                return k == a && "q" == e && d == h
            }
        }));
    ...
    var a, h, k = function () {
        function e(d, g) {
            ...
            if (this.s.dt.settings()[0]._bInitComplete) this._addStyles(),
                this._setKeyTableListener(); else d.one("init.dt", function () {
                m._addStyles();
        ...
        e.prototype._getCellCSS = function (d, g, m) {
            ...
            } : {left: g + "px", position: "sticky"} : this.s.rtl ? {
                left: g + "px",
                position: "sticky"
        ...
        e.prototype._clearCellCSS = function (d) {
            return "left" ===
            d ? this.s.rtl ? {position: "", right: ""} : {left: "", position: ""} : this.s.rtl ? {
                left: "",
                position: ""
            } : {position: "", right: ""}
        };
        e.prototype._setKeyTableListener = function () {
            ...
            this.s.dt.on("column-visibility", function (g, m) {
                m.bDestroying || setTimeout(function () {
                    d._addStyles()
                }, 50)
            })
        };
