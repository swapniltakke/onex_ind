...
where  c3.stage_id='4' and p.product_id=:product_id
and c1.station_id like :station_id";
$query = DbManager::fetchPDOQuery('spectra_db', $sql, [":product_id" => "$product_id", ":station_id" => "%$station_id%"])["data"];
...
foreach ($query as $data) {
    ...
    $query_remark = DbManager::fetchPDOQuery('spectra_db', $query_remark1, [":stage_id" => "4", ":station_id" => "$station_id", ":product_id" => "$product_id"])["data"];
