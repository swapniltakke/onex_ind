                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="hidden" class="form-control" id="station_id" name="station_id"
                                                readonly>
                                            <input type="text" class="form-control" id="station_name" name="station_name" placeholder="PAW" readonly>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (x.saved == "SAVED" && x.complete == "COMPLETE") {
                        ...
                        window.location.href = 'generatepaw.php';
                    }
                }
            });
        } else {
