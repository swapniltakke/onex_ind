 ...
 <!-- <nav class="main-header navbar navbar-expand navbar-white navbar-light"> -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="dashboard.html" class="brand-link">
      <img src="img/logo.jpg" alt="Spectra Logo" class="brand-image img-circle elevation-3" >
...
<li><div class="link"><a href="checksubassembly.php"><i class="fa fa-dashboard"></i><span>Subassembly Test</span></a></div></li>
   ...
   <li>
   <div class="link"><A href="index.html"> <i class="fa fa-sign-out nav-icon"></i><span>Logout</span></a></div>
