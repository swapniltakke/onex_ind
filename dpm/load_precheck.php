...
$sql = "SELECT c2.checklist_item,c2.id FROM tbl_checklistdetails as c1,tbl_checklist as c2,tbl_stage as c3 where c1.checklist_id=c2.id and c1.stage_id=c3.stage_id and c3.stage_id='1' ";
