...
if (isset($_GET["role_id"])) {
    ...
    $res = DbManager::fetchPDOQuery("spectra_db", $sql, [
        ":role_id" => $_GET["role_id"],
    ])["data"];
    foreach ($res as $result) {
        $role_name = trim($result["role_name"]);
    }
}
include "header.php";
...
<div class="content-wrapper">
  ...
  <a href="#"  class="tablinks" ><i class="fa fa-money"></i> </a>
	...
	<section class="content">
		<form role="form" name="myForm" method="POST" action="add_roles_action.php" enctype="multipart/form-data" name="add-form" id="add-form">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<!-- Default box -->
						<div class="framecontent">
							<div class="row">
								<div class="col-md-12">
									<div class="blockhead">
										<h3><i class="fa fa-map-marker"></i> Add Roles </h3>
									</div>
								</div>
							</div>
							<div class="card">
								<div class="card-body formarea smpadding">
									<br></br>
									<input type="hidden" name="update_type" id="update_type" value="<?php echo isset($_GET["role_id"])? "edit": "add"; ?>">
									<input type="hidden" name="role_id" id="role_id" value="<?php echo isset($_GET["role_id"])? $_GET["role_id"]: ""; ?>">
									<div class="row">
										<div class="col-md-2">
											<label> Enter Role:</label>
										</div>
										<div class="col-md-4">
											<input type="text" name="role_name" id="role_name" class="form-control" value="<?php echo $role_name; ?>" required>
										</div>
									</div>
								</div>
							</div>
