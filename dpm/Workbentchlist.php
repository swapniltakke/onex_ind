        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="framecontent">
               ...
               <a href="add_workbench.php"><span class="icon-input-btn">
...
<br>	</br>		
			...
			<div class="row">
				<div class="col-md-12">
					<div class="blockhead">
					<h3><i class="fa fa-map-marker"></i> Workbench Details</h3>
					</div>
				</div>
			   </div>
			<div class="card">
...
var table=  $('#example1').DataTable({
    'paging'      : true,
	 'lengthChange': true,
	  ...
	  'destroy': true,
	    "sAjaxSource": "load_workbenchlist.php",
         "aoColumns": [
                    {mData: 'sr_no'},
					{mData: 'title'},
					{mData: 'icon'},
